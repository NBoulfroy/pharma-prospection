/**
 * Javascript vanilla functions library for form HTML elements.
 *
...
function controlForm(id) {
    // Gets data from HTML content by the id passed in parameter.
    let form = document.getElementById(id);
    // Gets all inputs from the form previously return.
    let inputs = form.getElementsByTagName('input');

    for (i = 0; i < inputs.length - 1; i++) {
        if (!controlInput(
                inputs[i].getAttribute('id'),
                inputs[i].parentNode.parentNode.getAttribute('id'),
